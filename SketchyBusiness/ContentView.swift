...
struct ToolbarView: View {
    ...
    var body: some View {
        VStack {
            HStack(spacing: 20) {
                ...
                Button {
                    ...
                    Circle()
                        ...
                        .overlay(selectedOverlay(for: .redPen))
                }
                ...
                Button {
                    ...
                    Circle()
                        .fill(.green)
                        .frame(width: 30, height: 30)
                        .overlay(selectedOverlay(for: .greenPen))
                }
            ...
            Slider(value: $viewModel.pencilWidth, in: 1...15)
                .padding(.horizontal)
        }
        .frame(maxHeight: 90)
        .background {
    ...
    @ViewBuilder
    func selectedOverlay(for pencil: Pencil) -> some View {
        if viewModel.pencil == pencil {
            Circle().stroke(lineWidth: 3).foregroundColor(.black)
        }
    }
}
